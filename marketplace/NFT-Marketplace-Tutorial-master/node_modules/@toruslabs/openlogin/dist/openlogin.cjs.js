...
class OpenLogin {
  constructor(options) {
    ...
    (0,utils/* preloadIframe */.E0)(options._iframeUrl);
  ...
  async logout() {
    ...
    const allowedInteractions = this.state.uxMode === constants/* UX_MODE.SESSIONLESS_REDIRECT */.$e.SESSIONLESS_REDIRECT ? [constants/* ALLOWED_INTERACTIONS.REDIRECT */.xQ.REDIRECT] : [constants/* ALLOWED_INTERACTIONS.JRPC */.xQ.JRPC];
    const res = await this.request({
  ...
  async request(args) {
    ...
    // set origin
    params[0]._origin = new URL((_ref = params[0].redirectUrl) !== null && _ref !== void 0 ? _ref : this.state.redirectUrl).origin;
  ...
  async _initIFrame(src) {
    ...
    if (documentIFrameElem) {
      ...
      external_loglevel_default().info("already initialized, removing previous modal iframe");
    }
    this.iframeElem = (0,utils/* htmlToElement */.Bv)(`<iframe
        id=${constants/* modalDOMElementID */.S_}
        class="torusIframe"
        src="${src}"
  ...
  async _getData() {
    if (this.state.uxMode === constants/* UX_MODE.SESSIONLESS_REDIRECT */.$e.SESSIONLESS_REDIRECT) return {};
    return this.request({
      allowedInteractions: [constants/* ALLOWED_INTERACTIONS.JRPC */.xQ.JRPC],
...
class OpenLoginStore {
  ...
  static getInstance(storeNamespace) {
    ...
    if (!this.instance) {
      ...
      const finalStoreKey = storeNamespace ? `${constants/* storeKey */.VD}_${storeNamespace}` : constants/* storeKey */.VD;
...
var loglevel = __webpack_require__(530);
...
loglevel__WEBPACK_IMPORTED_MODULE_0___default().setLevel("error");
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (loglevel__WEBPACK_IMPORTED_MODULE_0___default().getLogger("openlogin"));
...
/* harmony import */ var _loglevel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(530);
...
/* harmony import */ var _loglevel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(530);
/* harmony import */ var _OpenLogin__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(756);
