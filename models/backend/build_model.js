            ...
            exec(command4, (error, stdout, stderr) => {
                ...
                exec(command5, (error, stdout, stderr) => {
                    ...
                    exec(command6, (error, stdout, stderr) => {
                        ...
                        let command7 = `export OPENAI_API_KEY=${openai_key} && openai api fine_tunes.create -t "sport2_prepared_train.jsonl" -v "sport2_prepared_valid.jsonl" --compute_classification_metrics --classification_positive_class " baseball" -m ada`;
