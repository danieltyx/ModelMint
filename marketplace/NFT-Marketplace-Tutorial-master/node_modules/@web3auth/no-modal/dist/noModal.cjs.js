...
class Web3AuthNoModal extends openlogin_jrpc_namespaceObject.SafeEventEmitter {
  ...
  configureAdapter(adapter) {
    ...
    if (adapter.name === base_namespaceObject.WALLET_ADAPTERS.WALLET_CONNECT_V2 && this.walletAdapters[base_namespaceObject.WALLET_ADAPTERS.WALLET_CONNECT_V1]) {
      throw base_namespaceObject.WalletInitializationError.invalidParams("Either one of wallet connect v2 or wallet connect v1 can be used, wallet connect v1 is already added to adapter lists.");
    }
    if (adapter.name === base_namespaceObject.WALLET_ADAPTERS.WALLET_CONNECT_V1 && this.walletAdapters[base_namespaceObject.WALLET_ADAPTERS.WALLET_CONNECT_V2]) {
      throw base_namespaceObject.WalletInitializationError.invalidParams("Either one of wallet connect v2 or wallet connect v1 can be used, wallet connect v2 is already added to adapter lists.");
    }
